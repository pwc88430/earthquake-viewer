...
public class InfoAPITester {
    ...
    /** Google Gson object for parsing Json Strings **/
    ...
    public static HttpRequest createRequest() {
        ...
        String uri = "https://contextualwebsearch-websearch-v1.p.rapidapi.com/api/Search/WebSearchAPI?q=earthquakenewstoday%20earthquake%20" + location + "%20" + time + "&pageNumber=1&pageSize=1&autoCorrect=true&safeSearch=true";
